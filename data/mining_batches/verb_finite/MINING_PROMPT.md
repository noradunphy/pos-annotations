...
- **Allowed labels (exact strings):** finite, non-finite

## Guidelines

finite = carries tense on finite clause verb; non-finite = infinitive/participle without finite inflection in role.
