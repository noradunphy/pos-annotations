# Mining task: `noun_collective`

You are labeling **one closed-class answer** per example for a single linguistic distinction.

## Distinction

- **Task id:** `noun_collective`
- **Parent POS (Tier A):** `NOUN`
- **Allowed labels (exact strings):** collective, non-collective

## Guidelines

collective = denotes a group as a unit (team, fleet); else non-collective.
