# Mining task: `adj_intersective`

You are labeling **one closed-class answer** per example for a single linguistic distinction.

## Distinction

- **Task id:** `adj_intersective`
- **Parent POS (Tier A):** `ADJ`
- **Allowed labels (exact strings):** intersective, non-intersective

## Guidelines

intersective = property narrows noun denotation; non-intersective = subsective/non-subsective modifier.
