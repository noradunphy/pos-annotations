...
- **Task id:** `adv_type`
- **Parent POS (Tier A):** `ADV`
- **Allowed labels (exact strings):** manner, time, place, degree, frequency, sentence_discourse

## Guidelines

sentence_discourse = sentential adverbs / discourse markers.
