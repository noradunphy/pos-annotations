...
- **Task id:** `det_type`
- **Parent POS (Tier A):** `DET`
- **Allowed labels (exact strings):** articles, demonstratives, possessives, quantifiers, numerals

## Guidelines

articles = a/an/the; numerals = bare number determiners.
