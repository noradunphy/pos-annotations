# Mining task: `verb_copular_prog_pass`

You are labeling **one closed-class answer** per example for a single linguistic distinction.

## Distinction

- **Task id:** `verb_copular_prog_pass`
- **Parent POS (Tier A):** `VERB`
- **Allowed labels (exact strings):** copular, progressive, passive, none_of_these

## Guidelines

copular = linking be/seem/remain etc.; progressive = -ing progressive aspect; passive = passive be + participle; none_of_these = other lexical use.
