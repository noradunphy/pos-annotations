# Mining task: `adj_attributive_predicative`

You are labeling **one closed-class answer** per example for a single linguistic distinction.

## Distinction

- **Task id:** `adj_attributive_predicative`
- **Parent POS (Tier A):** `ADJ`
- **Allowed labels (exact strings):** attributive, predicative

## Guidelines

attributive modifies NP internally; predicative = subject complement / resultative predicate.
