# Mining task: `verb_lexical_aux`

You are labeling **one closed-class answer** per example for a single linguistic distinction.

## Distinction

- **Task id:** `verb_lexical_aux`
- **Parent POS (Tier A):** `VERB`
- **Allowed labels (exact strings):** lexical, auxiliary

## Guidelines

auxiliary = finite modal or primary be/do/have supporting tense; else lexical.
