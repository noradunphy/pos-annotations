# Mining task: `noun_concrete_abstract`

You are labeling **one closed-class answer** per example for a single linguistic distinction.

## Distinction

- **Task id:** `noun_concrete_abstract`
- **Parent POS (Tier A):** `NOUN`
- **Allowed labels (exact strings):** concrete, abstract

## Guidelines

concrete = physical referent; abstract = idea, event nominalization, etc.
