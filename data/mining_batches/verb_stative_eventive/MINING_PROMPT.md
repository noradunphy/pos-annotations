# Mining task: `verb_stative_eventive`

You are labeling **one closed-class answer** per example for a single linguistic distinction.

## Distinction

- **Task id:** `verb_stative_eventive`
- **Parent POS (Tier A):** `VERB`
- **Allowed labels (exact strings):** stative, eventive

## Guidelines

stative = state without clear change; eventive = action or change of state.
