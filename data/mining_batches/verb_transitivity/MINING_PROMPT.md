# Mining task: `verb_transitivity`

You are labeling **one closed-class answer** per example for a single linguistic distinction.

## Distinction

- **Task id:** `verb_transitivity`
- **Parent POS (Tier A):** `VERB`
- **Allowed labels (exact strings):** transitive, intransitive, ditransitive, ambitransitive

## Guidelines

Use clause context: objects required for transitive/ditransitive; ambitransitive = both patterns attested.
