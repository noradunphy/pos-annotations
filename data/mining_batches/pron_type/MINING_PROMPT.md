...
- **Task id:** `pron_type`
- **Parent POS (Tier A):** `PRON`
- **Allowed labels (exact strings):** personal, possessive, reflexive, demonstrative, relative, interrogative, indefinite

## Guidelines

Classify pronominal paradigm, not case (see pron_case extension).
