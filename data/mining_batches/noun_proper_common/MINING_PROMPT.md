# Mining task: `noun_proper_common`

You are labeling **one closed-class answer** per example for a single linguistic distinction.

## Distinction

- **Task id:** `noun_proper_common`
- **Parent POS (Tier A):** `NOUN`
- **Allowed labels (exact strings):** proper, common

## Guidelines

proper = named entity or title-like noun; common = generic referent.
