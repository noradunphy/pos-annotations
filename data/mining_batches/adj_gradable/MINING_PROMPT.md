# Mining task: `adj_gradable`

You are labeling **one closed-class answer** per example for a single linguistic distinction.

## Distinction

- **Task id:** `adj_gradable`
- **Parent POS (Tier A):** `ADJ`
- **Allowed labels (exact strings):** gradable, non-gradable

## Guidelines

gradable allows degree modification; non-gradable = absolute or technical sense.
