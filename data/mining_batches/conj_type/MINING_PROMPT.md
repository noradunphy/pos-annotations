...
- **Task id:** `conj_type`
- **Parent POS (Tier A):** `CONJ`
- **Allowed labels (exact strings):** coordinating, subordinating

## Guidelines

coordinating = and/but/or; subordinating = if/because/although or subordinator use.
